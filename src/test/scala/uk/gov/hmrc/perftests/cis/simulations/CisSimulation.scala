...
//    continue journey to add subcontractor, verify subcontractor or subcontractor list
  ...
  setup("add-individual-subcontractor", "AISP ").withRequests(
    ...
    getTradingName,
    postTradingName("Test Subcontractor Ltd"),
    getAddIndividualAddressPage,
    postAddIndividualAddressPage("true"),
    getIndividualAddressPage,
    postIndividualAddressPage(
      "25 Oakley Road",
      "Flat 69",
      "City of Test",
      "TestCounty",
    ...
    getIndividualContactMethodPage,
    postIndividualContactMethodPage("noDetails"),
    getAddIndividualUtrPage,
    postAddIndividualUtrPage("true"),
    getIndividualUtrPage,
    postIndividualUtrPage("1234567895"),
    getAddIndividualNinoPage,
    postAddIndividualNinoPage("true"),
    getIndividualNinoPage,
    postIndividualNinoPage("AA123456C"),
    getAddIndividualWrnPage,
    postAddIndividualWrnPage("true"),
    getIndividualWrnPage,
    postIndividualWrnPage("12345678"),
    getIndividualCheckYourAnswersPage,
    getIndividualCheckYourAnswersPage,
    getChangeTradingNamePage,
    postChangeTradingNamePage("New Test Subcontractor Ltd"),
    getIndividualCheckYourAnswersPage,
    getChangeAddTradingNamePage,
    postChangeAddTradingNamePage("false"),
    getChangeIndividualNamePage,
    postChangeIndividualNamePage("John", "Test", "Doe"),
    getIndividualCheckYourAnswersPage,
    getChangeIndividualNamePage,
    postChangeIndividualNamePage("Jane", "Tester", "Doe"),
    getIndividualCheckYourAnswersPage,
    getChangeIndividualAddressPage,
    postChangeIndividualAddressPage(
      "123 Test Ave",
      "Flat 456",
      "Testing City",
      "Test County",
    ...
    getIndividualCheckYourAnswersPage,
    getChangeAddIndividualAddressPage,
    postChangeAddIndividualAddressPage("false"),
    getIndividualCheckYourAnswersPage,
    getChangeIndividualContactMethodPage,
    postChangeIndividualContactMethodPage("email"),
    getChangeIndividualEmailAddressPage,
    postChangeIndividualEmailAddressPage("test@domain.co.uk"),
    getIndividualCheckYourAnswersPage,
    getChangeIndividualNinoPage,
    postChangeIndividualNinoPage("JJ123456A"),
    getIndividualCheckYourAnswersPage,
    getChangeAddIndividualNinoPage,
    postChangeAddIndividualNinoPage("false"),
    getIndividualCheckYourAnswersPage,
    getChangeIndividualUtrPage,
    postChangeIndividualUtrPage("7777777777"),
    getIndividualCheckYourAnswersPage,
    getChangeAddIndividualUtrPage,
    postChangeAddIndividualUtrPage("false"),
    getIndividualCheckYourAnswersPage,
    getChangeIndividualWrnPage,
    postChangeIndividualWrnPage("78789934"),
    getIndividualCheckYourAnswersPage,
    getChangeAddIndividualWrnPage,
    postChangeAddIndividualWrnPage("false"),
    getIndividualCheckYourAnswersPage,
    postIndividualCheckYourAnswersPage,
    getIndividualSubcontractorAddedPage
  )
  ...
  setup("add-trust-subcontractor", "ATSP").withRequests(
    ...
    postAddTrustAddressPage("false"),
    getTrustContactMethodPage,
    postTrustContactMethodPage("noDetails"),
    getAddTrustUTRPage,
    postAddTrustUTRPage("false"),
    getAddTrustWrnPage,
    postAddTrustWrnPage("false"),
    getTrustCheckYourAnswersPage,
    getChangeTrustNamePage,
    postChangeTrustNamePage("CIS Test Trust Change"),
    getTrustCheckYourAnswersPage,
    getChangeAddTrustAddressPage,
    postChangeAddTrustAddressPage("true"),
    ...
    postChangeTrustContactMethodPage("email"),
    getChangeTrustEmailAddressPage,
    postChangeTrustEmailAddressPage("john.doe.update@hmrc.co.uk"),
    getTrustCheckYourAnswersPage,
    getChangeAddTrustWrnPage,
    postChangeAddTrustWrnPage("true"),
    getChangeTrustWrnPage,
    postChangeTrustWrnPage("ref54321"),
    getTrustCheckYourAnswersPage,
    getChangeAddTrustUTRPage,
    postChangeAddTrustUTRPage("true"),
