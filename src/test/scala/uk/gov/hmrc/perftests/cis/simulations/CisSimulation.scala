...
class CisSimulation extends Simulation with PerformanceTestRunner {
  ...
  setup("standard-monthly-return", "SMRP").withRequests(
    ...
    postYouHaveAddedDetailsForASingleSubcontractor(""),
    getWhichSubcontractorDoYouNeedToAddPaymentDetailsFor,
    postWhichSubcontractorDoYouNeedToAddPaymentDetailsFor(""),
    getHowMuchDidYouPayToSecondSubcontractorInTotalPage,
    postHowMuchDidYouPayToSecondSubcontractorInTotalPage("5000"),
    ...
    postYouHaveAddedDetailsFor2Subcontractors(""),
    getAreYouSureYouWantToRemoveFirstSubcontractor,
    postAreYouSureYouWantToRemoveFirstSubcontractor(""),
    getYouHaveAddedDetailsForASingleSubcontractor,
    postYouHaveAddedDetailsForASingleSubcontractor(""),
    getSummaryOfPaymentsMade,
    postSummaryOfPaymentsMade,
    getDoYouConfirmTheInformationInThisReturnIsCorrect,
    postDoYouConfirmTheInformationInThisReturnIsCorrect(""),
    getDeclarationOfEmploymentStatus,
    postDeclarationOfEmploymentStatus(""),
    getDeclarationOfVerifiedStatus,
    postDeclarationOfVerifiedStatus(""),
    getSubmitInactivityRequest,
    postSubmitInactivityRequest(""),
    getDoYouWantConfirmationByEmailThatThisReturnHasBeenSuccessfullySubmitted,
    postDoYouWantConfirmationByEmailThatThisReturnHasBeenSuccessfullySubmitted(""),
    getCheckYourAnswersBeforeSubmittingYourReturn,
    getChangeDeclarationOfEmploymentStatus,
    postChangeDeclarationOfEmploymentStatus(""),
    getCheckYourAnswersBeforeSubmittingYourReturn,
    getChangeDeclarationOfVerifiedStatus,
    postChangeDeclarationOfVerifiedStatus(""),
    getCheckYourAnswersBeforeSubmittingYourReturn,
    getChangeSubmitInactivityRequest,
    postChangeSubmitInactivityRequest(""),
    getInactivityRequest,
    postInactivityRequest,
    getCheckYourAnswersBeforeSubmittingYourReturn,
    getChangeDoYouWantConfirmationByEmailThatThisReturnHasBeenSuccessfullySubmitted,
    postChangeDoYouWantConfirmationByEmailThatThisReturnHasBeenSuccessfullySubmitted(""),
    getEnterYourEmailAddress,
    postEnterYourEmailAddress(""),
    getCheckYourAnswersBeforeSubmittingYourReturn,
