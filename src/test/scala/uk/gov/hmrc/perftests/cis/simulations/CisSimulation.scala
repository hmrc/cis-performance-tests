...
class CisSimulation extends Simulation with PerformanceTestRunner {
  ...
  setup("standard-monthly-return", "SMRP").withRequests(
    ...
    getYouHaveAdded2Subcontractors,
    ...
    postChangeHowMuchDidYouPayToFirstSubcontractorInTotalDetails("3000"),
    getChangeFirstSubcontractorsDetails,
    ...
    getYouHaveAddedASingleSubcontractor,
    ...
    getYouHaveAddedASingleSubcontractor,
    postYouHaveAddedASingleSubcontractor("false"),
